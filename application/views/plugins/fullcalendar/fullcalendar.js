...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		titleHtml =
			'<span class="fc-title">' +
				(htmlEscape(event.nome || '') || '&nbsp;') + // sempre queremos uma linha de altura
			'</span>';
...
function Calendar_constructor(element, overrides) {
	...
	// calcular a data inicial do fuso horário ambig
	...
	function setOptions(newOptionHash) {
		...
		if (optionCnt === 1) {
			if (optionName === 'height' || optionName === 'contentHeight' || optionName === 'aspectRatio') {
				...
				return; // não é possível alterar a data desta forma. use gotoDate em vez disso
			}
