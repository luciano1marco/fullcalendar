   ...
   <footer id="myFooter">
       <div class="row"> </div>
        <div class="content-fluid">
            <div class="col-sm-3">
                <a href="#">
                    <img class="img-responsive" src="/fullcalendar/images/brasao.png" width="200" height="150" >
                </a>
            </div>
            <div class="col-sm-6">
    ...
    <p> Todos direitos reseverdos ₢2022 - Prefeitura Municipal de Rio Grande </p> 
...
<script type="text/javascript">
 $(document).ready(function ($) {    
        $.backstretch('/fullcalendar/images/sala3.jpg');     
    });
</script> 
