...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		titleHtml =
			...
			'</span>' +
			'<span class="fc-title">' + '&nbsp' +
				(htmlEscape(event.mesa || ' ') || '&nbsp;') + // mostra a mesa na view
			'</span>' ;
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	//Calcula qual deve ser o título na parte superior do calendário para esta visualização
	computeTitle: function() {
		return this.formatRange(
			{
				// in case intervalStart/End has a time, make sure timezone is correct
				//caso intervalStart/End tenha um horário, verifique se o fuso horário está correto
...
fcViews.listDay = {
	...
	duration: { days: 1 },
	defaults: {
		listDayFormat: 'dddd' // dia da semana é tudo o que precisamos. a data completa provavelmente está no cabeçalho
	}
};
